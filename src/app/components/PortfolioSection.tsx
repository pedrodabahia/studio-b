      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div style={{backgroundImage : `url(${project.imagem})`, backgroundSize : '132%',backgroundRepeat: "no-repeat", backgroundPosition : 'center'}} className="aspect-video  from-[#FFD700]/20 to-transparent flex items-center justify-center">
